...
public class CommonUtil {
	...
	public static String getFile_dir_pds() {
		String pdsDir = "C:/track_kju/work_project/web_homepage_jsl/WebContent/attach/pds/";
		return pdsDir;
	}
	
	// 뉴스 첨부 경로
	public static String getFile_dir_news(){
		String newsDir = "C:/track_kju/work_project/web_servelet_bike/WebContent/attach/news/";	
		return newsDir;
		}
	
	// 공지사항 첨부 경로
	public static String getFile_dir_notice(){
	String noticeDir = "C:/track_kju/work_project/web_servelet_bike/WebContent/attach/notice/";	
	return noticeDir;
	}
